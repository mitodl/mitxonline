...
- fix: Repair the reused test DB after transaction=True tests (which do not use pytest's normal transaction) (#3917)
- Fix AGENTS.md Django version (5.1 -> 5.2) (#3910)
...
Version 1.163.1 (Released August 24, 2026)
---------------
