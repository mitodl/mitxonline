...
# already decided the learner is entitled to it (today: the verified program
# enrollment flow in ecommerce.api). Discount.is_redeemable_by refuses it, so
# no code-redemption route can attach one, and pricing does not re-check
# eligibility. Its product links say what it is for, not where it applies.
