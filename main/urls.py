...
from main.views import cms_signin_redirect_to_site_signin, index, refine, staff_dashboard_signin_redirect_to_site_signin
...
urlpatterns = [
    ...
    re_path(r"^staff-dashboard/$", staff_dashboard_signin_redirect_to_site_signin, name="staff-dashboard-login"),
