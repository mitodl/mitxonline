...
class DiscountShapeMixin:
    ...
    ValidationError out of Model.save().
    ...
    def validate(self, attrs):
        ...
        # An internal discount is inert only while it stays internal; any other
        # redemption type would make its code a live 100%-off code.
        if (
