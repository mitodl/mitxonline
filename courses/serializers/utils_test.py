...
class TestGetTopicsFromPage:
    ...
    def test_get_topics_from_page_with_parent_topics(self):
        ...
        child_topic2 = CoursesTopicFactory.create(name="Chemistry", parent=parent_topic1)
        child_topic3 = CoursesTopicFactory.create(name="Programming", parent=parent_topic2)
    ...
    def test_get_topics_from_page_with_multiple_parent_topics(self):
        ...
        physics_topic = CoursesTopicFactory.create(name="Physics", parent=science_parent)
        programming_topic = CoursesTopicFactory.create(name="Programming", parent=tech_parent)
        music_topic = CoursesTopicFactory.create(name="Music", parent=arts_parent)
        
        mock_page = Mock()
        mock_page.topics.all.return_value = [physics_topic, programming_topic, music_topic]
    ...
    def test_get_topics_from_page_with_course_page_object(self):
        ...
        child_topic1 = CoursesTopicFactory.create(name="Machine Learning", parent=parent_topic)
        child_topic2 = CoursesTopicFactory.create(name="Data Science", parent=parent_topic)
