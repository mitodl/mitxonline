...
import RegisterAdditionalDetailsPage, {
  RegisterAdditionalDetailsPage as InnerRegisterAdditionalDetailsPage
} from "./RegisterAdditionalDetailsPage"
...
describe("RegisterAdditionalDetailsPage", () => {
  const detailsData = {
    name:          "Sally",
  ...
  beforeEach(() => {
    ...
    renderPage = helper.configureHOCRenderer(
      ...
      InnerRegisterAdditionalDetailsPage,
      {},
      {
        location: {
