...
def test_serialize_contact_removes_semicolons_from_course_run_names(
    ...
    mocker.patch.object(
        course_run_cert.course_run,
        "__str__",
        return_value="Test Course; Run With Semicolon",
    )
    ...
    assert (
        serialized_data["course_run_certificates"] == "Test Course Run With Semicolon"
    )
...
def test_serialize_contact_multiple_certificates_with_semicolons(
    ...
    mocker.patch.object(program_cert_1.program, "__str__", return_value="Program; One")
    mocker.patch.object(program_cert_2.program, "__str__", return_value="Program; Two")
    mocker.patch.object(
